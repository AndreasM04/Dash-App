            ...
            html.Div(children = [
                ...
                html.Div(children = [
                    ...
                    html.Div(children = [
                        ...
                        html.P(children = f'Current Period: {averageRPU}', style = {'position':'absolute', 'color':'black', 'margin-left':'50px', 'top':'500px', 'font-size':'13px', 'font-family':'sans-serif'})
                ...
                html.Div(children = [
                    ...
                    html.Div(children = [
                        ...
                        html.P(children = f'Current Period: {acquisitionCost}', style = {'position':'absolute', 'color':'black', 'margin-left':'50px', 'top':'660px', 'font-size':'13px', 'font-family':'sans-serif'})
